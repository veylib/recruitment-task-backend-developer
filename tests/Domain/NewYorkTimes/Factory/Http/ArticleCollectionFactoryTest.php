...
namespace App\Tests\Domain\NewYorkTimes\Factory\Http;
...
class ArticleCollectionFactoryTest extends TestCase
{
...
JSON;
        $factory = new ArticleCollectionFactory(new ArticleMapper());
        $articleCollection = $factory->create(json_decode($json, true));
